...
public class App {
  ...
  public static SearchResponse callSynchronously(final SearchRequest searchRequest)
      throws IOException {
  ...
  public static void callASynchronously(final SearchRequest searchRequest) {
    final RestHighLevelClient restHighLevelClient = elasticsearchConfig.restHighLevelClient();
